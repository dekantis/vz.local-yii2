<div class="row">
    ...
    <div class="row">
            ...
            <p class="text-indent text-justify lead">Здесь помогают тем, кто тысячи лет верно служит человеку, разделяя с ним очаг и кров. Тем, кто преданно смотрит Вам в глаза в минуты печали и неутолимо резвится в дни радости. Здесь лечат животных! Вы и только Вы – самые лучшие,
                самые добрые и самые умные. А мы, ветеринарные врачи, знаем о болезнях животных чуть больше лишь только потому, что обучались этой профессии и ежедневно сталкиваемся с подобными проблемами у братьев наших меньших. Мы, Ваши
    ...
    <div class="rowrecomendation">
        ...
        <div class="recomendation-block col-md-4">
            <p class="text-indent text-justify lead">
                Дорогой посетитель сайта, пусть Ваш питомец будет здоров, пусть его недуги не омрачают жизнь и пусть встречи с Вашим ветеринаром будут носить лишь профилактический характер.
            </p>
        </div>
